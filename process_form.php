...
if ($result->num_rows > 0) {
    ...
    if ($stmt->execute()) {
        ...
        $message = "Registration successful!<br>Your Reference ID is: " . $reg_no."<br><h4>This reference id will be send to your registered mail id and this will helpfull for future reference</h4>";
        ...
        // Content
        $body = "
            <img src='https://www.ksrmce.ac.in/data1/images/s2.jpg' alt='Sample Image' style='max-width: 100%; height: auto;'>
