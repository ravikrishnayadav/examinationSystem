...
if(isset($_POST['form_submit'])) { // Check if form is submitted
  ...
  header('Location: print_application_form.html');
  exit();
}
?>
<!DOCTYPE html>
...
<div class="container-fluid">
  ...
  <strong>Something Went Wrong!</strong> Registration Id Invalid <a href="print_application_form.html"><b>Click </b></a>for preview
